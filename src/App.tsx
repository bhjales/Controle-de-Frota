      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        {!currentUser ? (
          ...
          <div className="max-w-md mx-auto space-y-6 py-6 animate-fade-in">
            ...
            {/* 💡 Quick Access Helper dashboard block for demonstration review ease */}
            <div className="bg-[#EEF2FF] border border-blue-100 rounded-3xl p-5 space-y-3">
              <span className="text-[10px] uppercase font-bold tracking-wider text-blue-800 flex items-center gap-1.5 font-mono">
                <HelpCircle className="w-4 h-4 text-blue-600" />
                Acesso Rápido de Testes (Usuários Pré-cadastrados)
              </span>
              <p className="text-xs text-slate-650 leading-relaxed font-medium">
                Use os botões de atalho abaixo para fazer login instantâneo usando o <strong>Login Pré-cadastrado</strong> dos usuários mock do sistema:
              </p>
              ...
              <div className="flex flex-col gap-2 pt-1">
                <button
                  ...
                  className="w-full py-2 bg-white hover:bg-blue-50/50 text-[#1E293B] text-xs font-bold rounded-xl border border-slate-200/80 flex items-center justify-between px-3.5 transition-all shadow-xs hover:border-blue-200 cursor-pointer"
                >
                  <span className="flex items-center gap-1.5">
                    <span className="text-slate-400">🛡️</span> Admin Principal:
                    <span className="font-mono font-bold text-blue-700 bg-blue-50 px-2 py-0.5 rounded border border-blue-200/40">admin</span>
                  </span>
                  <span className="text-[10px] bg-[#0F172A] text-white px-2 py-0.5 rounded-md font-mono font-bold">LOGAR</span>
                </button>

                <button
                  type="button"
                  id="quick_joao_login_btn"
                  onClick={() => handleQuickAccess('joao')}
                  className="w-full py-2 bg-white hover:bg-blue-50/50 text-[#1E293B] text-xs font-bold rounded-xl border border-slate-200/80 flex items-center justify-between px-3.5 transition-all shadow-xs hover:border-blue-200 cursor-pointer"
                >
                  <span className="flex items-center gap-1.5">
                    <span className="text-slate-400">🚙</span> João Silva (Motorista):
                    <span className="font-mono font-bold text-blue-700 bg-blue-50 px-2 py-0.5 rounded border border-blue-200/40">joao</span>
                  </span>
                  <span className="text-[10px] bg-[#0F172A] text-white px-2 py-0.5 rounded-md font-mono font-bold">LOGAR</span>
                </button>
                ...
                <button
                  type="button"
                  id="quick_maria_login_btn"
                  onClick={() => handleQuickAccess('maria')}
                  className="w-full py-2 bg-white hover:bg-blue-50/50 text-[#1E293B] text-xs font-bold rounded-xl border border-slate-200/80 flex items-center justify-between px-3.5 transition-all shadow-xs hover:border-blue-200 cursor-pointer"
                >
                  <span className="flex items-center gap-1.5">
                    <span className="text-slate-400">🚙</span> Maria Souza (Motorista):
                    <span className="font-mono font-bold text-blue-700 bg-blue-50 px-2 py-0.5 rounded border border-blue-200/40">maria</span>
                  </span>
                  <span className="text-[10px] bg-[#0F172A] text-white px-2 py-0.5 rounded-md font-mono font-bold">LOGAR</span>
                </button>
                ...
                <button
                  type="button"
                  id="quick_gerente_login_btn"
                  onClick={() => handleQuickAccess('gerente')}
                  className="w-full py-2 bg-white hover:bg-amber-50/50 text-[#1E293B] text-xs font-bold rounded-xl border border-slate-200/80 flex items-center justify-between px-3.5 transition-all shadow-xs hover:border-amber-200 cursor-pointer"
                >
                  <span className="flex items-center gap-1.5">
                    <span className="text-slate-400">📊</span> Gerente Geral (Perfil Gerencial):
                    <span className="font-mono font-bold text-amber-700 bg-amber-50 px-2 py-0.5 rounded border border-amber-200/40">gerente</span>
                  </span>
                  <span className="text-[10px] bg-amber-600 text-white px-2 py-0.5 rounded-md font-mono font-bold">LOGAR</span>
                </button>
              </div>
            </div>
          </div>
